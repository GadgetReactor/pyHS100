...
@cli.command()
@click.argument("h", type=click.FloatRange(0, 1), default=None)
@click.argument("s", type=click.FloatRange(0, 1), default=None)
@click.argument("v", type=click.FloatRange(0, 1), default=None)
@pass_dev
def hsv(dev, h, s, v):
